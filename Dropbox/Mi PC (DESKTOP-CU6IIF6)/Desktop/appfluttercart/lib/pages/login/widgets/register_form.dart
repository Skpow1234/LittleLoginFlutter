...
import 'package:flutter_cart_app/utils/app_colors.dart';
import 'package:flutter_cart_app/utils/dialogs.dart';
...
class _RegisterFormState extends State<RegisterForm> {
  ...
  _submit() async {
    ...
    if (usernameOk && emailOk && passwordOk && vpasswordOk) {
      ...
      Dialogs.alert(context, description: "Algunos campos invalidos");
    }
  }
